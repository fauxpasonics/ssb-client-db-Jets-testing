...
--base set
		SELECT 
			...
			/*Phone*/
			, COALESCE(LEFT(phone_day,25),LEFT(phone_eve,25),LEFT(phone_cell,25),LEFT(phone_fax,25)) AS [PhonePrimary]
			...
			, CASE WHEN ISNULL(acct_id,'') != '' AND ISNULL(cust_name_id,'') != '' THEN   'TM-' + CAST(acct_id AS VARCHAR(50)) + ':' + CAST(cust_name_id AS NVARCHAR(50))
				ELSE NULL
