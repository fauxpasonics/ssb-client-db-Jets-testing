...
AS
	...
	SELECT    ssbid.SSB_CRMSYSTEM_CONTACT_ID
              ...
              --, CASE WHEN COALESCE(tex.LastTEXPurchaseDate,
              --                     tm.LastTMPurchaseDate, '') = '' THEN 0
              --       ELSE 1
              ...
              --, CASE WHEN tex.SSB_CRMSYSTEM_CONTACT_ID IS NOT NULL
              --       THEN DATEDIFF(dd, tex.LastTEXPurchaseDate, GETDATE())
              --       ELSE NULL
              --  END Days_Since_Ticket_Exchange_Purchase
              --, CASE WHEN tm.SSB_CRMSYSTEM_CONTACT_ID IS NOT NULL
              --       THEN DATEDIFF(dd, tm.LastTMPurchaseDate, GETDATE())
              --       ELSE NULL
              --  END Days_Since_Ticket_Master_Purchase
              --, CASE WHEN COALESCE(tex.LastTEXPurchaseDate,
              --                     tm.LastTMPurchaseDate, '') = '' THEN NULL
              ...
              --                           )
              --                   THEN DATEDIFF(dd, tm.LastTMPurchaseDate,
              --                                 GETDATE())
              --                   ELSE DATEDIFF(dd, tex.LastTEXPurchaseDate,
              --                                 GETDATE())
              --              END )
              --  END Days_Since_Any_Ticket_Purchase
              , ssbid.SSB_CRMSYSTEM_PRIMARY_FLAG AS SSB_Primary_Record_Flag
              --, dimcustomer.ExtAttribute22 AS Last_Purchase_Date
