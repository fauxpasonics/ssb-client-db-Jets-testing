CREATE TABLE [tmarc].[FILE_ssb_jets15_20171101_FP_cust_donor_level_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_jets15_20171101_FP_cust_donor_level_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24455C844F3B] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
