CREATE TABLE [tmarc].[FILE_jets16FULLNOTEF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLNOTEF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445A356F0F3] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
