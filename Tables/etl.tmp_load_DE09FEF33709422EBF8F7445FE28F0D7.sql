CREATE TABLE [etl].[tmp_load_DE09FEF33709422EBF8F7445FE28F0D7]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_DE09FEF33709422EBF8F7445FE28F0D7_ss] ON [etl].[tmp_load_DE09FEF33709422EBF8F7445FE28F0D7] ([SourceSystem], [SSID])
GO
