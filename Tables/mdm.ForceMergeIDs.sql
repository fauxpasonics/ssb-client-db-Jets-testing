...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceMerg__Creat__2F483801] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceMerg__Updat__303C5C3A] DEFAULT (getdate()),
