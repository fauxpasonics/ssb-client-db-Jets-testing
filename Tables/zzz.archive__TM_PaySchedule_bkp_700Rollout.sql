CREATE TABLE [zzz].[archive__TM_PaySchedule_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_PaySchedule_bkp_700Rollout] ADD CONSTRAINT [PK__TM_PaySc__C4EA244538CCF84A] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
