CREATE TABLE [tmarc].[FILE_jets16FULLATTENDF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLATTENDF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445059493D8] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
