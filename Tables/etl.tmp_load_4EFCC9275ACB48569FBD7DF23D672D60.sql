CREATE TABLE [etl].[tmp_load_4EFCC9275ACB48569FBD7DF23D672D60]
(
...
[IsBusiness] [bit] NULL,
[Customer_Matchkey] [nvarchar] (104) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4EFCC9275ACB48569FBD7DF23D672D60_ss] ON [etl].[tmp_load_4EFCC9275ACB48569FBD7DF23D672D60] ([SourceSystem], [SSID])
GO
