CREATE TABLE [tmarc].[FILE_ssb_jets13_20171101_FP_manifest_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_jets13_20171101_FP_manifest_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445C28B4082] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
