CREATE TABLE [tmarc].[FILE_jets16FULLTEXF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLTEXF] ADD CONSTRAINT [PK__FILE_jet__C4EA24459C0026F2] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
