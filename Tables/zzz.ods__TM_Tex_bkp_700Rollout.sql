...
GO
ALTER TABLE [zzz].[ods__TM_Tex_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Tex__3213E83FF7694C64] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_Key] ON [zzz].[ods__TM_Tex_bkp_700Rollout] ([activity], [event_id], [section_id], [row_id], [seat_num], [num_seats], [add_datetime])
GO
