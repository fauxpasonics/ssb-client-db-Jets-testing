...
GO
CREATE NONCLUSTERED INDEX [IX_AccountId] ON [dbo].[DimCustomer] ([AccountId]) INCLUDE ([CustomerType], [SourceSystem])
GO
...
GO
CREATE NONCLUSTERED INDEX [ix_DimCustomer__LastName] ON [dbo].[DimCustomer] ([LastName]) INCLUDE ([DimCustomerId])
GO
...
GO
CREATE NONCLUSTERED INDEX [dq_gender] ON [dbo].[DimCustomer] ([SourceSystem], [CD_Gender]) INCLUDE ([SSID])
GO
