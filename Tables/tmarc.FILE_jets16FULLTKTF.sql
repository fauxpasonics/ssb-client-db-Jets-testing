CREATE TABLE [tmarc].[FILE_jets16FULLTKTF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLTKTF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445A6C6F193] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
