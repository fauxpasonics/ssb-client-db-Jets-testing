CREATE TABLE [etl].[tmp_load_C1D8C007A8564E96ACBD122BF5364658]
(
...
[IsBusiness] [bit] NULL,
[Customer_Matchkey] [varchar] (52) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C1D8C007A8564E96ACBD122BF5364658_ss] ON [etl].[tmp_load_C1D8C007A8564E96ACBD122BF5364658] ([SourceSystem], [SSID])
GO
