CREATE TABLE [tmarc].[FILE_ssb_jets15_20171101_FP_retail_non_ticket_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_jets15_20171101_FP_retail_non_ticket_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445D5A58D19] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
