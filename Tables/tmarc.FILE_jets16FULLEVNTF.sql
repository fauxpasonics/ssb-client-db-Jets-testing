CREATE TABLE [tmarc].[FILE_jets16FULLEVNTF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLEVNTF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445B3FB6332] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
