CREATE TABLE [tmarc].[FILE_jets16FULLSOLICITF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLSOLICITF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445A208EB71] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
