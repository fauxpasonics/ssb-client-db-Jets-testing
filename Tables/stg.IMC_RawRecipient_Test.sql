CREATE TABLE [stg].[IMC_RawRecipient_Test]
(
...
GO
ALTER TABLE [stg].[IMC_RawRecipient_Test] ADD CONSTRAINT [PK__IMC_RawR__C4EA2445598844E6] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
