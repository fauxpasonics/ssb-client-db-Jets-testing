CREATE TABLE [tmarc].[FILE_ssb_jets14_20171101_FP_manifest_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_jets14_20171101_FP_manifest_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445FE040498] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
