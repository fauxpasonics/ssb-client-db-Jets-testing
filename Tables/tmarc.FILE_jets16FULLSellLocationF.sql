CREATE TABLE [tmarc].[FILE_jets16FULLSellLocationF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLSellLocationF] ADD CONSTRAINT [PK__FILE_jet__C4EA24459B7A0345] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
