CREATE TABLE [tmarc].[FILE_jets16FULLPromoCodeF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLPromoCodeF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445991B4349] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
