CREATE TABLE [tmarc].[FILE_jets16FULLclassF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLclassF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445BDFDAA5A] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
