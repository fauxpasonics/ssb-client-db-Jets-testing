...
GO
ALTER TABLE [zzz].[ods__TM_Journal_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Journ__3213E83F688855E8] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_BizKey] ON [zzz].[ods__TM_Journal_bkp_700Rollout] ([journal_Seq_id])
GO
