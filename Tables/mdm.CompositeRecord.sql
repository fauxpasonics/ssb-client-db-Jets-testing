CREATE TABLE [mdm].[CompositeRecord]
(
...
GO
ALTER TABLE [mdm].[CompositeRecord] ADD CONSTRAINT [PK_CompositeRecord] PRIMARY KEY CLUSTERED  ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_AddressFourIsCleanStatus] ON [mdm].[CompositeRecord] ([AddressFourIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_AddressOneIsCleanStatus] ON [mdm].[CompositeRecord] ([AddressOneIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_AddressPrimaryIsCleanStatus] ON [mdm].[CompositeRecord] ([AddressPrimaryIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_AddressThreeIsCleanStatus] ON [mdm].[CompositeRecord] ([AddressThreeIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_AddressTwoIsCleanStatus] ON [mdm].[CompositeRecord] ([AddressTwoIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_CompanyName] ON [mdm].[CompositeRecord] ([CompanyName]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_CompanyNameIsCleanStatus] ON [mdm].[CompositeRecord] ([CompanyNameIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_EmailOneIsCleanStatus] ON [mdm].[CompositeRecord] ([EmailOneIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_EmailPrimaryIsCleanStatus] ON [mdm].[CompositeRecord] ([EmailPrimaryIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_EmailTwoIsCleanStatus] ON [mdm].[CompositeRecord] ([EmailTwoIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhoneBusinessIsCleanStatus] ON [mdm].[CompositeRecord] ([PhoneBusinessIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhoneCellIsCleanStatus] ON [mdm].[CompositeRecord] ([PhoneCellIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhoneFaxIsCleanStatus] ON [mdm].[CompositeRecord] ([PhoneFaxIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhoneHomeIsCleanStatus] ON [mdm].[CompositeRecord] ([PhoneHomeIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhoneOtherIsCleanStatus] ON [mdm].[CompositeRecord] ([PhoneOtherIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhonePrimaryIsCleanStatus] ON [mdm].[CompositeRecord] ([PhonePrimaryIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IDX_mdmCompositeRecords_UpdatedDate_ACCTCONTACTIDs] ON [mdm].[CompositeRecord] ([UpdatedDate]) INCLUDE ([SSB_CRMSYSTEM_ACCT_ID], [SSB_CRMSYSTEM_CONTACT_ID])
GO
