CREATE TABLE [zzz].[archive__TM_RetailNonTicket_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_RetailNonTicket_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Retai__C4EA24452162354E] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
