CREATE TABLE [tmarc].[FILE_ssb_jets13_20171101_FP_inv_line_item_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_jets13_20171101_FP_inv_line_item_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA244501A93868] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
