CREATE TABLE [tmarc].[FILE_jets16FULLEventsInPlanF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLEventsInPlanF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445109C97A5] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
