...
GO
ALTER TABLE [zzz].[ods__TM_RetailNonTicket_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Retai__3213E83F8E0C5EC9] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_Key] ON [zzz].[ods__TM_RetailNonTicket_bkp_700Rollout] ([retail_event_id], [event_id], [first_seat], [num_seats]) INCLUDE ([event_name], [refund_flag], [row_name], [section_name])
GO
