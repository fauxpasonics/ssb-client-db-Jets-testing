CREATE TABLE [etl].[tmp_load_99A2DBE52F1C453FA20C2749723EFD12]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_99A2DBE52F1C453FA20C2749723EFD12_ss] ON [etl].[tmp_load_99A2DBE52F1C453FA20C2749723EFD12] ([SourceSystem], [SSID])
GO
