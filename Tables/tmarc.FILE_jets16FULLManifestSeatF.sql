CREATE TABLE [tmarc].[FILE_jets16FULLManifestSeatF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLManifestSeatF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445327D23EB] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
