CREATE TABLE [tmarc].[FILE_jets16FULLRETAILEVENTF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLRETAILEVENTF] ADD CONSTRAINT [PK__FILE_jet__C4EA244531975258] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
