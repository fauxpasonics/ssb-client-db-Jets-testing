CREATE TABLE [etl].[tmp_load_B3D559ECD6FB48B2A2CE185FA07F8A64]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_B3D559ECD6FB48B2A2CE185FA07F8A64_ss] ON [etl].[tmp_load_B3D559ECD6FB48B2A2CE185FA07F8A64] ([SourceSystem], [SSID])
GO
