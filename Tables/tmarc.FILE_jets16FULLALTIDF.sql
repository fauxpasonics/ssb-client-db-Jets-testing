CREATE TABLE [tmarc].[FILE_jets16FULLALTIDF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLALTIDF] ADD CONSTRAINT [PK__FILE_jet__C4EA24450A2E5016] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
