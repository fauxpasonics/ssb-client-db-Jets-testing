...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_dbo__FactInventory] ON [dbo].[FactInventory]
GO
CREATE NONCLUSTERED INDEX [IX_ETL_UpdatedDate] ON [dbo].[FactInventory] ([ETL_UpdatedDate] DESC)
GO
