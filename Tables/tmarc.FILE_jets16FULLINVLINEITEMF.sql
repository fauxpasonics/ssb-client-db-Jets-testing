CREATE TABLE [tmarc].[FILE_jets16FULLINVLINEITEMF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLINVLINEITEMF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445643E4E9F] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
