CREATE TABLE [tmarc].[FILE_ssb_jets13_20171101_FP_attrib_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_jets13_20171101_FP_attrib_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445DB790D10] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
