CREATE TABLE [tmarc].[FILE_ssb_jets14_20171101_FP_promo_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_jets14_20171101_FP_promo_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA2445DF91EF0C] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
