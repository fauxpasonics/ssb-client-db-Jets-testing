CREATE TABLE [tmarc].[FILE_ssb_jets13_20171101_FP_ledger_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_jets13_20171101_FP_ledger_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24453B48ED43] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
