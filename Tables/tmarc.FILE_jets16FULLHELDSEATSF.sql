CREATE TABLE [tmarc].[FILE_jets16FULLHELDSEATSF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLHELDSEATSF] ADD CONSTRAINT [PK__FILE_jet__C4EA24459D563B01] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
