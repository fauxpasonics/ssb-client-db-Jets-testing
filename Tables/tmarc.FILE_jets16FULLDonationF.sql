CREATE TABLE [tmarc].[FILE_jets16FULLDonationF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLDonationF] ADD CONSTRAINT [PK__FILE_jet__C4EA24454959E7CE] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
