CREATE TABLE [tmarc].[FILE_jets16FULLMEMBERF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLMEMBERF] ADD CONSTRAINT [PK__FILE_jet__C4EA244590B5BB17] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
