CREATE TABLE [tmarc].[FILE_jets16FULLCUSTF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLCUSTF] ADD CONSTRAINT [PK__FILE_jet__C4EA24453F0DA901] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
