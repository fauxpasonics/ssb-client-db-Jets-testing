CREATE TABLE [tmarc].[FILE_jets16FULLJOURNALF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLJOURNALF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445AC0F088B] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
