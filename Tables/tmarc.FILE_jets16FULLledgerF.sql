CREATE TABLE [tmarc].[FILE_jets16FULLledgerF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLledgerF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445C8604209] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
