CREATE TABLE [archive].[TM_Ticket]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__TM_Ticket] ON [archive].[TM_Ticket]
GO
CREATE NONCLUSTERED INDEX [IX_acct_id] ON [archive].[TM_Ticket] ([acct_id])
GO
