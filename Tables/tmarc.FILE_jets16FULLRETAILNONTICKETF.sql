CREATE TABLE [tmarc].[FILE_jets16FULLRETAILNONTICKETF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLRETAILNONTICKETF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445573EB083] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
