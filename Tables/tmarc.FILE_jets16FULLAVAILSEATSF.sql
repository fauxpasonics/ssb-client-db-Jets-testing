CREATE TABLE [tmarc].[FILE_jets16FULLAVAILSEATSF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLAVAILSEATSF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445AAC6BBCD] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
