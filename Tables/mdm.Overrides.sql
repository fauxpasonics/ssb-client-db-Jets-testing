...
[StatusID] [int] NULL CONSTRAINT [DF_Overrides_new_StatusID] DEFAULT ((1)),
[CreatedDate] [datetime] NULL CONSTRAINT [DF_Overrides_new_CreatedDate] DEFAULT (getdate()),
[CreatedBy] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_Overrides_new_CreatedBy] DEFAULT (suser_sname()),
[UpdatedDate] [datetime] NULL CONSTRAINT [DF_Overrides_new_UpdatedDate] DEFAULT (getdate()),
[UpdatedBy] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ActivatedDate] [datetime] NULL CONSTRAINT [DF_Overrides_new_ActivatedDate] DEFAULT (getdate()),
...
GO
ALTER TABLE [mdm].[Overrides] ADD CONSTRAINT [PK_Overrides_new_OverrideID] PRIMARY KEY CLUSTERED  ([OverrideID])
GO
ALTER TABLE [mdm].[Overrides] ADD CONSTRAINT [UC_Overrides_new] UNIQUE NONCLUSTERED  ([DimCustomerID], [ElementID], [Field])
GO
CREATE NONCLUSTERED INDEX [IX_Overrides_new_ElementID] ON [mdm].[Overrides] ([ElementID])
GO
ALTER TABLE [mdm].[Overrides] ADD CONSTRAINT [FK_Overrides_new_DimCustomerID] FOREIGN KEY ([DimCustomerID]) REFERENCES [dbo].[DimCustomer] ([DimCustomerId])
GO
