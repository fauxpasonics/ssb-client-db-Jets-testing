CREATE TABLE [tmarc].[FILE_jets16FULLCUSTTRACEF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLCUSTTRACEF] ADD CONSTRAINT [PK__FILE_jet__C4EA244530E7FFA2] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
