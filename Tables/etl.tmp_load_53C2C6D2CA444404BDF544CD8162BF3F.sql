CREATE TABLE [etl].[tmp_load_53C2C6D2CA444404BDF544CD8162BF3F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_53C2C6D2CA444404BDF544CD8162BF3F_ss] ON [etl].[tmp_load_53C2C6D2CA444404BDF544CD8162BF3F] ([SourceSystem], [SSID])
GO
