CREATE TABLE [etl].[tmp_load_5938F4D36ED64DEE929719AA2A0D93F0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_5938F4D36ED64DEE929719AA2A0D93F0_ss] ON [etl].[tmp_load_5938F4D36ED64DEE929719AA2A0D93F0] ([SourceSystem], [SSID])
GO
