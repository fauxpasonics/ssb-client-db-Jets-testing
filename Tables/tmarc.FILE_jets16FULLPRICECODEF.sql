CREATE TABLE [tmarc].[FILE_jets16FULLPRICECODEF]
(
...
GO
ALTER TABLE [tmarc].[FILE_jets16FULLPRICECODEF] ADD CONSTRAINT [PK__FILE_jet__C4EA2445F0B07A0D] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
