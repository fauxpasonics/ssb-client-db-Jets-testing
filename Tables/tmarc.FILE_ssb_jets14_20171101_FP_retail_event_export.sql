CREATE TABLE [tmarc].[FILE_ssb_jets14_20171101_FP_retail_event_export]
(
...
GO
ALTER TABLE [tmarc].[FILE_ssb_jets14_20171101_FP_retail_event_export] ADD CONSTRAINT [PK__FILE_ssb__C4EA24459DC21E27] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
