CREATE TABLE [zzz].[ods__TM_CustAddress_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[ods__TM_CustAddress_bkp_700Rollout] ADD CONSTRAINT [PK__TM_CustA__3213E83F57FCA912] PRIMARY KEY CLUSTERED  ([id])
GO
